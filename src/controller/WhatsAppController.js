   ...
   initEvents() {
      ...
      this.el.inputDocument.on('change', e => {
         ...
         this._documentPreviewController.getPreviewData().then(result => {
            ...
            this.el.infoPanelDocumentPreview.addClass('open');
            ...
            switch(file.type){
               ...
               case 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet':
                   this.el.iconPanelDocumentPreview.className = 'jcxw icon-doc-xls';
                  break;

               default:
                  this.el.iconPanelDocumentPreview.className = 'jcxw icon-doc-generic';
